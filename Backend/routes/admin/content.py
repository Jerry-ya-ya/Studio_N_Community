...
def serialize_registered_member(user, coins=0):
    ...
    return {
        ...
        'capabilityDirection': user.capability_direction,
        'capabilityStack': user.capability_stack,
        'capabilityFocus': user.capability_focus,
        'capabilityStyle': user.capability_style,
        'sort_order': user.id,
